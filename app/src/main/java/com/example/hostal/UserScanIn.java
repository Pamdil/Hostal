...
public class UserScanIn extends AppCompatActivity {
    ...
    private void openScanner() {
        ...
        integrator.setCaptureActivity(ScanActivity.class); // Ensure ScanActivity is defined
            ...
            if (result.getContents() != null) {
                ...
                if (id != null) {
                    ...
                    databaseReference.child(id).setValue(qrData)
                            .addOnSuccessListener(aVoid -> Toast.makeText(UserScanIn.this, "QR Code saved to database", Toast.LENGTH_SHORT).show())
                            .addOnFailureListener(e -> Toast.makeText(UserScanIn.this, "Failed to save QR code", Toast.LENGTH_SHORT).show());
                }
            } else {
